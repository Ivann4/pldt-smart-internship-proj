    ...
    <main class="main">
        <div class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="text" id="Description" name="Description" placeholder="is a type of task...">
            </div>
            <div class="form-group full-width">
                <label for="text">Proponent</label>
                <input type="text" id="Proponent" name="Proponent" placeholder="Mr. John Doe">
                <label for="phone">Proponent's Department</label>
            ...
            <div class="form-group full-width">
                <label for="address">Assign Task to</label>
                <input type="text" id="assign-task" name="assign-task" placeholder="jane Doe">
            </div>
            <div class="form-group">
